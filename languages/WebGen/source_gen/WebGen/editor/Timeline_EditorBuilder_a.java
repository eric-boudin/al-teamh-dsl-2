...
/*package*/ class Timeline_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Timeline_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    if (nodeCondition_it2b2t_a2a()) {
      editorCell.addEditorCell(createComponent_0());
    }
    return editorCell;
  }
  private boolean nodeCondition_it2b2t_a2a() {
    return Objects.equals(SNodeOperations.getConcept(SNodeOperations.getParent(myNode)), CONCEPTS.Grid$Tp);
  }
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "Timeline displaying post like");
