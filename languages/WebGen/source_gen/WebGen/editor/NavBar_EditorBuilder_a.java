...
/*package*/ class NavBar_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_0() {
    ...
    if (nodeCondition_ql8thq_a2a()) {
      editorCell.addEditorCell(createComponent_0());
    }
    return editorCell;
  }
  private boolean nodeCondition_ql8thq_a2a() {
    return Objects.equals(SNodeOperations.getConcept(SNodeOperations.getParent(myNode)), CONCEPTS.Grid$Tp);
  }
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "Navbar contains");
