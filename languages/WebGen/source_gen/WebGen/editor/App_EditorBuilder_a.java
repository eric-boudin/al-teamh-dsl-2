...
/*package*/ class App_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new themeSingleRoleHandler_g38wqt_d0(myNode, LINKS.theme$cCAv, getEditorContext());
    return provider.createCell();
  }
  private static class themeSingleRoleHandler_g38wqt_d0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public themeSingleRoleHandler_g38wqt_d0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new templatesListHandler_g38wqt_f0(myNode, getEditorContext());
  ...
  private static class templatesListHandler_g38wqt_f0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public templatesListHandler_g38wqt_f0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(templatesListHandler_g38wqt_f0.this.getNode(), LINKS.templates$EdJP));
      try {
  ...
  private EditorCell createRefNodeList_1() {
    AbstractCellListHandler handler = new pagesListHandler_g38wqt_h0(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Indent(), false);
  ...
  private static class pagesListHandler_g38wqt_h0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public pagesListHandler_g38wqt_h0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(pagesListHandler_g38wqt_h0.this.getNode(), LINKS.pages$hjQ2));
      try {
        EditorCell emptyCell = null;
    ...
    private EditorCell createConstant_5() {
      ...
      editorCell.setCellId("Constant_g38wqt_a7a");
      editorCell.setDefaultText("");
      return editorCell;
    }
  }
